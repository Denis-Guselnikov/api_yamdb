# Generated by Django 2.2.16 on 2022-08-24 17:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, max_length=150, verbose_name='Первое имя')),
                ('last_name', models.CharField(blank=True, max_length=150, verbose_name='Фамилия')),
                ('bio', models.TextField(blank=True, verbose_name='Биография')),
                ('role', models.CharField(blank=True, choices=[('admin', 'admin'), ('moderator', 'moderator'), ('user', 'user')], default='user', max_length=255, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(null=True, validators=[django.core.validators.MaxValueValidator(10)], verbose_name='Оценка')),
